  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 px-4 md:px-8 py-8 md:py-8 min-h-[300px] md:min-h-[450px] relative">
        ...
        <motion.div 
          className="flex-1 md:flex-[1.2] flex justify-center md:absolute md:right-0 md:bottom-0 items-end self-end -mb-4 md:-mb-8 order-first md:order-last"
          variants={staggerItem}
        >
          <img 
            src="/Frame 633535.png" 
            alt="Hero Section Illustration" 
            className="w-full max-w-sm md:max-w-lg md:w-auto h-auto object-contain scale-90 md:scale-[1.21]"
          />
        </motion.div>
      </div>
    </motion.div>
